{
    'name': 'Academy Theme',
    'description': 'Academy Theme',
    'category': 'Theme/Education',
    'summary': 'Academy on demand experiences',
    'version': '2.1.0',
    'author': 'Wizeline',
    'depends': ['website'],
    'data': [
    ...
    #     'website.s_cover_default_image': '/theme_bewise/static/src/img/backgrounds/hero-4-768x0-c-default.jpg',
    ...
    'assets': {
        'web._assets_primary_variables': [
            ('prepend', 'academy/static/src/scss/primary_variables.scss'),
        ],
    }
}
